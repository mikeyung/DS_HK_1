...
### linkedin_2.py
###
### Python program to output my connections' skills by scraping their Linkedin profile
### with BeautifulSoup
###
### Input - n/a
### Output -
...
#       self.loginPage()
    ...
    def loadSkill(self):
        ...
        f_skill = open('/Users/michaelyung/DS_HK_1/finals/mikeyung/output_connections_skills_line.csv', 'w')
        
        i = 1

        f_skill.write('"Connection", "Skill"' + '\n')
        for line in f_url:
            print i, line            
